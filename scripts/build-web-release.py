"""Build the chat-first web release with an explicit local-service allowlist."""
...
helper=web+service+[root/'scripts/launch.ps1',root/'scripts/install-connector.ps1',root/'安装连接助手.cmd']
