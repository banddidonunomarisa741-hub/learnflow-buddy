...
helper=web+service+[root/p for p in ['package.json','LICENSE','scripts/launch.ps1','scripts/install-connector.ps1','安装连接助手.cmd','docs/WORKBUDDY-AUTH-CREDITS.md','docs/TEACHER-CONNECTION-1.7.md','docs/PROJECTS-MOTION-1.8.md','docs/UI-CLARITY-1.8.1.md']]
